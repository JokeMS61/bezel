...
#
# Run the build process by entering 'createexe.py' or
# 'python createexe.py' in a console prompt.
#
...
class BuildExe:
    def __init__(self):
        ...
        self.copyright = "Copyright (c) 2017 JK."

        #Description
        self.project_description = "dash application"
